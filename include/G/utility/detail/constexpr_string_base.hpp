...
namespace gal::gui::utility::detail
{
	...
	struct constexpr_string_base
	{
		...
		[[nodiscard]] constexpr operator std::basic_string_view<value_type>() const noexcept
		{
		...
		[[nodiscard]] constexpr operator std::basic_string<value_type>() const noexcept
		{
