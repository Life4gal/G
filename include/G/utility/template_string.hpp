...
#include <G/utility/detail/constexpr_string_base.hpp>
...
namespace gal::gui::utility
{
	namespace template_string_detail
	{
		...
		struct basic_template_string : detail::constexpr_string_base<basic_template_string<T, Chars...>, T>
		{
			using value_type								   = T;
		...
		struct basic_bilateral_template_string<basic_template_string<T, Left...>, basic_template_string<T, Right...>>
			: detail::bilateral_constexpr_string_base<
		...
		struct basic_multiple_template_string<BasicTemplateString, BasicTemplateStrings...>
			: detail::multiple_constexpr_string_base<
		...
		{
			using base_type		 = detail::multiple_constexpr_string_base<basic_multiple_template_string<BasicTemplateString, BasicTemplateStrings...>, typename BasicTemplateString::value_type, typename BasicTemplateString::size_type, BasicTemplateString, BasicTemplateStrings...>;
